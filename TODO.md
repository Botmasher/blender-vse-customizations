...
- [ ] save loc/rot/scale points and animate between them over n frames (allow push XOR pull anims)
	- even togglable mode where you move/rot/scale object, it sets kfs n frames apart, you can reverse for in/out
- [ ] shape key cycles init>fin>init values in/out (close-open,open-close) or continuous (unblink-blink-unblink)
- [ ] auto stretch/squash
